...
<link href="<?php echo e(asset('domandas/css/chartist.min.css')); ?>" rel="stylesheet">
...
<div class="row">
    ...
    <div class="col-md-5">
            ...
            <h5><i class="fa fa-university" aria-hidden="true"></i> Company: <?php echo e($user->company); ?></h5>
...
<div class="row">
    <div class="col-md-offset-4">
        <h3>Current Contribute Point of 2017: <b><span style="color: #2A3542;"><?php echo e($user->credit); ?> points</span></b></h3>
...
<script src="<?php echo e(asset('domandas/js/chartist.min.js')); ?>"></script>
