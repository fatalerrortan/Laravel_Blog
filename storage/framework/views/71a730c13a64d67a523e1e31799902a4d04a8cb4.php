    ...
    <div class="row">
        <table class="table table-striped">
            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr post_id="<?php echo e($post['id']); ?>">
                    <th class="post_id" scope="row"><?php echo e($post['id']); ?></th>
                    <td class="post_title"><a class="social-icon" href="http://<?php echo e($_SERVER['HTTP_HOST']); ?>/blog/public/post/<?php echo e($post['id']); ?>"><?php echo e($post['title']); ?></a></td>
                    <td class="post_category"><?php echo e($post['category']); ?></td>
                    <td class="post_updated_at"><?php echo e($post['updated_at']); ?></td>
