...
<?php $__env->startSection('contents'); ?>
    <div class="row">
        <div class="col-lg-4 col-md-2">
            <h2 id="category" class="post-title"><?php echo e($category); ?></h2>
        </div>
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1" id="posts_container">
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="post-preview">
                    <a class="post_id" href="https://<?php echo e($_SERVER['HTTP_HOST']); ?>/post/<?php echo e($post['id']); ?>">
                        <h5>
                            <?php echo e($post['title']); ?>

                        </h5>
                    </a>
                    <p class="post-meta">Posted by <a href="https://<?php echo e($_SERVER['HTTP_HOST']); ?>/about"><?php echo e($post['autor']); ?></a> <span class="updated_at"><?php echo e($post['created_at']); ?></span>
