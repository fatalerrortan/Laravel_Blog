                ...
                <li id="mail_notificatoin_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo">
                                    <img class="img-responsive img-circle" width="70px" height="70px" src="<?php echo e(asset('domandas/img/pp1.png')); ?>" alt="">
                                </span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo">
                                    <img class="img-responsive img-circle" width="70px" height="70px" src="<?php echo e(asset('domandas/img/pp2.png')); ?>" alt="">
                                </span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo">
                                    <img class="img-responsive img-circle" width="70px" height="70px" src="<?php echo e(asset('domandas/img/pp3.png')); ?>" alt="">
                                </span>
                                <span class="subject">
