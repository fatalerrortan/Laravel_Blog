            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(secure_url('/posts/php')); ?>">All for PHP</a></li>
                        <li><a href="<?php echo e(secure_url('/posts/php_magento')); ?>">Magento</a></li>
                        <li><a href="<?php echo e(secure_url('/posts/php_laravel')); ?>">Laravel</a></li>
                    </ul>
                </li>
                <li>
                ...
                <div class="site-heading">
                    <h1>Xulin Blog
                        <a id="newletter" class="social-icon">
                            <img class="img-responsive" src="<?php echo e(asset("img/letter.png")); ?>" alt="newsletter" style="display: inline">
